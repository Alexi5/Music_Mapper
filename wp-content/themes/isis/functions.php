...
function isis_filter_wp_title( $old_title, $sep, $sep_location ){
    ...
    if( is_category() ) $insert = $ssep . __('Category','isis');
    elseif( is_tag() ) $insert = $ssep . __('Tag','isis');
    elseif( is_author() ) $insert = $ssep . __('Author','isis');
    elseif( is_year() || is_month() || is_day() ) $insert = $ssep . __('Archives','isis');
