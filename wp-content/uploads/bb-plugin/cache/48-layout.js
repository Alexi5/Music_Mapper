...
var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://music-mapper-wp-alex15j.c9users.io/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'https://music-mapper-wp-alex15j.c9users.io/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);var wpAjaxUrl='https://music-mapper-wp-alex15j.c9users.io/wp-admin/admin-ajax.php';var flBuilderUrl='https://music-mapper-wp-alex15j.c9users.io/wp-content/plugins/beaver-builder-lite-version/';